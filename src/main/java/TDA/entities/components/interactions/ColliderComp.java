...
public class ColliderComp extends Component {
    ...
    public ColliderComp(float topOffsetPercentage, float bottomOffsetPercentage, float leftOffsetPercentage, float rightOffsetPercentage) {
    ...
    public float getXCollisionAdjustment(float newX) {
        ...
        for (Entity other : GameManager.currentScene.getEntitiesWithComponents(ColliderComp.class)) {
            ColliderComp otherCollider = other.getComponent(ColliderComp.class);
    ...
    public float getYCollisionAdjustment(float newY) {
        ...
        for (ColliderComp other : GameManager.currentScene.entityManager.getColliders()) {
    ...
    private boolean isColliding(Transform transformToCheck, ColliderComp other) {
