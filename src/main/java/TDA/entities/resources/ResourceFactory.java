    ...
    public static Entity createResourceOfType(Class<? extends Resource> resourceType) {
        if (resourceType.equals(Tree.class)) {
            return new Entity(new Transform(new Vector2f(1300, 300), new Vector2f(400, 400)))
                           .addComponent(new QuadComponent("src/assets/images/seperateImages/tree2.png", Layer.FOREGROUND))
        ...
        if (resourceType.equals(Stone.class)) {
            return new Entity(new Transform(new Vector2f(1000, 300), new Vector2f(150, 150)))
                           .addComponent(new QuadComponent("src/assets/images/seperateImages/stone2.png", Layer.FOREGROUND))
        ...
        if (resourceType.equals(Metal.class)) {
            return new Entity(new Transform(new Vector2f(1600, 300), new Vector2f(150, 150)))
                           .addComponent(new QuadComponent("src/assets/images/seperateImages/metal2.png", Layer.FOREGROUND))
